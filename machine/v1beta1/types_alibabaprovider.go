...
const (
	...
	AlibabaDiskPerformanceLevel0 AlibabaDiskPerformanceLevel = "PL0"
	// AlibabaDiskPerformanceLevel1 enum property to set the level at PL1
	AlibabaDiskPerformanceLevel1 AlibabaDiskPerformanceLevel = "PL1"
	// AlibabaDiskPerformanceLevel2 enum property to set the level at PL2
	AlibabaDiskPerformanceLevel2 AlibabaDiskPerformanceLevel = "PL2"
	// AlibabaDiskPerformanceLevel3 enum property to set the level at PL3
	AlibabaDiskPerformanceLevel3 AlibabaDiskPerformanceLevel = "PL3"
...
type SystemDiskProperties struct {
	...
	// +kubebuilder:validation:Enum="AlibabaDiskCatagoryUltraDisk"; "AlibabaDiskCategorySSD", "AlibabaDiskCategoryESSD"; "AlibabaDiskCategoryBasic"
	// +optional
	...
	// +kubebuilder:validation:Enum="AlibabaDiskPerformanceLevel0"; "AlibabaDiskPerformanceLevel1", "AlibabaDiskPerformanceLevel2"; "AlibabaDiskPerformanceLevel3"
	// +optional

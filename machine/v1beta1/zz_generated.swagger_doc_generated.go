...
var map_AlibabaCloudMachineProviderConfig = map[string]string{
	"":                  "AlibabaCloudMachineProviderConfig is the Schema for the alibabacloudmachineproviderconfig API Compatibility level 2: Stable within a major release for a minimum of 9 months or 3 minor releases (whichever is longer).",
	...
	"securityGroups":    "SecurityGroups is a list of security group references to assign to the instance. A reference holds either the security group ID or the required tags to search. The  limit of N values varies based on the maximum number of security groups to which an instance can belong. For more information, see the \"Security group limits\" section in Limits. https://www.alibabacloud.com/help/doc-detail/101348.htm?spm=a2c63.p38356.879954.48.78f0199aX3dfIE",
	...
	"vSwitch":           "VSwitch is a reference to the vswitch to use for this instance This parameter is required when you create an instance of the VPC type. You can call the DescribeVSwitches operation to query the created vSwitches.",
	...
	"resourceGroupId":   "ResourceGroupID is the unique ID of the resource group to which to assign the instance.",
...
var map_AlibabaCloudMachineProviderConfigList = map[string]string{
	"": "AlibabaCloudMachineProviderConfigList contains a list of AlibabaCloudMachineProviderConfig Compatibility level 2: Stable within a major release for a minimum of 9 months or 3 minor releases (whichever is longer).",
}
...
var map_AlibabaCloudMachineProviderStatus = map[string]string{
	"":              "AlibabaCloudMachineProviderStatus is the Schema for the alibabacloudmachineproviderconfig API Compatibility level 2: Stable within a major release for a minimum of 9 months or 3 minor releases (whichever is longer).",
...
var map_AlibabaResourceReference = map[string]string{
	...
	"id":   "ID of resource",
	"tags": "Tags is a set of metadata based upon ECS object tags used to identify a resource",
}
...
var map_BandwidthProperties = map[string]string{
	...
	"internetMaxBandwidthIn":  "When the purchased outbound public bandwidth is less than or equal to 10 Mbit/s, the valid values of this parameter are 1 to 10. Currently the default is `10` when outbound bandwidth is less than or equal to 10 Mbit/s. When the purchased outbound public bandwidth is greater than 10, the valid values are 1 to the InternetMaxBandwidthOut value. Currently the default is the value used for `InternetMaxBandwidthOut` when outbound public bandwidth is greater than 10.",
	"internetMaxBandwidthOut": "InternetMaxBandwidthOut is the maximum outbound public bandwidth. Unit: Mbit/s. Valid values: 0 to 100. Empty value means no opinion and the platform chooses the a default, which is subject to change over time. Currently the default is `0`",
}
...
var map_SystemDiskProperties = map[string]string{
	...
	"performanceLevel": "PerformanceLevel is the performance level of the ESSD used as the system disk. Empty value means no opinion and the platform chooses a default, which is subject to change over time. Currently the default is `PL1`. Valid values:\n\nPL0: A single ESSD can deliver up to 10,000 random read/write IOPS. PL1: A single ESSD can deliver up to 50,000 random read/write IOPS. PL2: A single ESSD can deliver up to 100,000 random read/write IOPS. PL3: A single ESSD can deliver up to 1,000,000 random read/write IOPS. For more information about ESSD performance levels, see ESSDs.",
	...
	"size":             "Size is the size of the system disk. Unit: GiB. Valid values: 20 to 500. The value must be at least 20 and greater than or equal to the size of the image. The default value is 40 or the size of the image, depending on whichever is greater.",
}
